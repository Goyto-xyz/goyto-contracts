...
const ipfs_hash = "testipfshash";
const call = checkinController.populate("add_spot", [ipfs_hash]);
const response = await checkinController.add_spot(call.calldata);

await provider.waitForTransaction(response.transaction_hash);

console.log("✅ Added new spot!", response.transaction_hash);
